---
name: 16-eyes-worker
description: Generic security-investigation worker for the 16-eyes agents — profiles a repo, designs lenses, investigates one lens, verifies one finding, or tries to refute one finding, exactly as instructed in each delegation. Invoked explicitly (@16-eyes-worker) by the 16-eyes-audit, 16-eyes-audit-diff, and 16-eyes-init agents, once per lens/finding — not meant to be invoked directly by a human.
